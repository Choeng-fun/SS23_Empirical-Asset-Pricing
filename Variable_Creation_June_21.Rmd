...
```{r}
# Select only necessary variables from the comprehensive data set
panel_reduced_CEI<- panel_country[!is.na(RET.USD),c("Id","ym","MV.USD","RET.USD")]
...
panel_reduced_CEI[,lag_5 := shift(CEI,-1), by = "Id"]
panel_reduced_CEI[,lag_4:=shift(CEI,-2), by = "Id"]
panel_reduced_CEI[,lag_3:=shift(CEI,-3), by = "Id"]
panel_reduced_CEI[,lag_2:=shift(CEI,-4), by = "Id"]
panel_reduced_CEI[,lag_1:=shift(CEI,-5), by = "Id"]
panel_reduced_CEI[,lag_12:=shift(CEI,-6), by = "Id"]
panel_reduced_CEI[,lag_11:=shift(CEI,-7), by = "Id"]
panel_reduced_CEI[,lag_10:=shift(CEI,-8), by = "Id"]
panel_reduced_CEI[,lag_9:=shift(CEI,-9), by = "Id"]
panel_reduced_CEI[,lag_8:=shift(CEI,-10), by = "Id"]
panel_reduced_CEI[,lag_7:=shift(CEI,-11), by = "Id"]

panel_reduced_CEI[,CEI:=0]
panel_reduced_CEI[month==6, CEI:=CEI, by = "Id"]
panel_reduced_CEI[month==5, CEI:=lag_5, by = "Id"]
panel_reduced_CEI[month==4, NSI:=lag_4, by = "Id"]
panel_reduced_CEI[month==3, NSI:=lag_3, by = "Id"]
panel_reduced_CEI[month==2, NSI:=lag_2, by = "Id"]
panel_reduced_CEI[month==1, NSI:=lag_1, by = "Id"]
panel_reduced_CEI[month==12, NSI:=lag_12, by = "Id"]
panel_reduced_CEI[month==11, NSI:=lag_11, by = "Id"]
panel_reduced_CEI[month==10, NSI:=lag_10, by = "Id"]
panel_reduced_CEI[month==9, NSI:=lag_9, by = "Id"]
panel_reduced_CEI[month==8, NSI:=lag_8, by = "Id"]
panel_reduced_CEI[month==7, NSI:=lag_7, by = "Id"]
