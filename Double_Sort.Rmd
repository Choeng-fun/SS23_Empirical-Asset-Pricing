...
Factor_data_ff5[,month:=month(ym)]
Factor_data_ff5[,year:=year(ym)]
...
setorder(Factor_data_ff5,ym,-MV) 
hlpvariable_size <-  Factor_data_ff5[month==7 & !is.na(MV),
...
portfolio_returns_HML[,t.test(SMB)]
...
portfolio_returns_RMW[,t.test(SMB)]
...
portfolio_returns_CMA[,t.test(SMB)]
...
portfolio_returns_WML[,t.test(SMB)]
