...
#### 2.8.1 Momentum_12_2 (cumulative return)
...
panel_reduced_CEI <- panel_reduced_CEI[, CEI:= na.locf(CEI_a, na.rm=FALSE)]
# ===END OF NEW CODE===
>>>>>>> cd5ba4188540edb34f4a1d4a952c4197565a3ab3
...
#### 4.2.3 E/P
```{r}
Univariate_Sort_Set_EP <- Univariate_Sort_Set[!is.na(`E/P`),c("Id","ym","MV.USD","RET.USD","E/P")]
...
#### 4.2.4 E/Pm
```{r}
Univariate_Sort_Set_EPm <- Univariate_Sort_Set[!is.na(`E/Pm`),c("Id","ym","MV.USD","RET.USD","E/Pm")]
...
#### 4.2.5 C/P
```{r}
Univariate_Sort_Set_CP <- Univariate_Sort_Set[!is.na(`C/P`),c("Id","ym","MV.USD","RET.USD","C/P")]
...
#### 4.2.6 C/Pm
```{r}
Univariate_Sort_Set_CPm <- Univariate_Sort_Set[!is.na(`C/Pm`),c("Id","ym","MV.USD","RET.USD","C/Pm")]
...
#### 4.2.7 EBITDA/EV
```{r}
Univariate_Sort_Set_EE <- Univariate_Sort_Set[!is.na(`EBITDA/EV`),c("Id","ym","MV.USD","RET.USD","EBITDA/EV")]
...
#### 4.3.1 Log_MV
```{r}
Univariate_Sort_Set_lnMV <- Univariate_Sort_Set[!is.na(Log_MV),c("Id","ym","MV.USD","RET.USD","Log_MV")]
...
#### 4.3.2 MV
```{r}
Univariate_Sort_Set_MV <- Univariate_Sort_Set[!is.na(MV),c("Id","ym","MV.USD","RET.USD","MV")]
...
#### 4.4.1 RSI
```{r}
Univariate_Sort_Set_RSI <- Univariate_Sort_Set[!is.na(RSI),c("Id","ym","MV.USD","RET.USD","RSI")]
...
#### 4.4.2 Alpha_3
```{r}
Univariate_Sort_Set_alpha_3 <- Univariate_Sort_Set[!is.na(Alpha_3),c("Id","ym","MV.USD","RET.USD","Alpha_3")]
...
#### 4.4.3 Momentum_12_2
```{r}
Univariate_Sort_Set_momentum <- Univariate_Sort_Set[!is.na(Mom_12_2),c("Id","ym","MV.USD","RET.USD","Mom_12_2")]
...
#### 4.5.1 DY
```{r}
Univariate_Sort_Set_yield <- Univariate_Sort_Set[!is.na(DY),c("Id","ym","MV.USD","RET.USD","DY")]
...
#### 4.6.1 ROE
```{r}
Univariate_Sort_Set_ROE <- Univariate_Sort_Set[!is.na(ROE),c("Id","ym","MV.USD","RET.USD","ROE")]
...
#### 4.6.2 ROA
```{r}
Univariate_Sort_Set_ROA <- Univariate_Sort_Set[!is.na(ROA),c("Id","ym","MV.USD","RET.USD","ROA")]
...
#### 4.6.3 GP/A
```{r}
Univariate_Sort_Set_GPA <- Univariate_Sort_Set[!is.na(`GP/A`),c("Id","ym","MV.USD","RET.USD","GP/A")]
...
#### 4.6.4 OP/BE
```{r}
Univariate_Sort_Set_OPBE <- Univariate_Sort_Set[!is.na(`OP/BE`),c("Id","ym","MV.USD","RET.USD","OP/BE")]
...
#### 4.6.5 NOA
```{r}
Univariate_Sort_Set_NOA <- Univariate_Sort_Set[!is.na(NOA),c("Id","ym","MV.USD","RET.USD","NOA")]
...
#### 4.6.6 OA
```{r}
Univariate_Sort_Set_OA <- Univariate_Sort_Set[!is.na(OA),c("Id","ym","MV.USD","RET.USD","OA")]
...
#### 4.7.1 Beta_3
```{r}
Univariate_Sort_Set_beta_3 <- Univariate_Sort_Set[!is.na(Beta_3),c("Id","ym","MV.USD","RET.USD","Beta_3")]
...
#### 4.7.2 Sigma_3
```{r}
Univariate_Sort_Set_sigma_3 <- Univariate_Sort_Set[!is.na(Sigma_3),c("Id","ym","MV.USD","RET.USD","Sigma_3")]
...
#### 4.7.3 SD
```{r}
Univariate_Sort_Set_sd <- Univariate_Sort_Set[!is.na(SD),c("Id","ym","MV.USD","RET.USD","SD")]
...
#### 4.9.1 EPS
```{r}
Univariate_Sort_Set_eps <- Univariate_Sort_Set[!is.na(EPS),c("Id","ym","MV.USD","RET.USD","EPS")]
...
#### 4.9.2 SPS
```{r}
Univariate_Sort_Set_sps <- Univariate_Sort_Set[!is.na(SPS),c("Id","ym","MV.USD","RET.USD","SPS")]
...
#### 4.10.1 AG
```{r}
Univariate_Sort_Set_inv <- Univariate_Sort_Set[!is.na(AG),c("Id","ym","MV.USD","RET.USD","AG")]
...
#### 4.10.2 NSI
```{r}
Univariate_Sort_Set_NSI <- Univariate_Sort_Set[!is.na(NSI),c("Id","ym","MV.USD","RET.USD","NSI")]
...
#### 4.10.3 CEI
```{r}
Univariate_Sort_Set_CEI <- Univariate_Sort_Set[!is.na(CEI),c("Id","ym","MV.USD","RET.USD","CEI")]
...
#### 4.10.4 I/A
```{r}
Univariate_Sort_Set_IA <- Univariate_Sort_Set[!is.na(`I/A`),c("Id","ym","MV.USD","RET.USD","I/A")]
