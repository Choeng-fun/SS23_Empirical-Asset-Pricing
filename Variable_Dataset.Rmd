...
```{r}
Univariate_Sort_Set_BM <- Univariate_Sort_Set_BM %>% 
  group_by(ym) %>%
  arrange(-MV.USD) %>%
  mutate(size=ifelse((cumsum(MV.USD)/sum(MV.USD))>=0.9,"Small","Big")) %>%
  filter(size=="Big") %>% 
  ungroup() %>% 
...
setorder(Univariate_Sort_Set_lnMV,ym,-MV.USD) 

Univariate_Sort_Set_lnMV <-  Univariate_Sort_Set_lnMV[, size := ifelse((cumsum(MV.USD)/sum(MV.USD))>=0.9,"Small","Big"),by=ym]

Univariate_Sort_Set_lnMV <- Univariate_Sort_Set_lnMV[size=="Big"]
...
setorder(Univariate_Sort_Set_MV,ym,-MV.USD) 

Univariate_Sort_Set_MV <-  Univariate_Sort_Set_MV[, size := ifelse((cumsum(MV.USD)/sum(MV.USD))>=0.9,"Small","Big"),by=ym]

Univariate_Sort_Set_MV <- Univariate_Sort_Set_MV[size=="Big"]
