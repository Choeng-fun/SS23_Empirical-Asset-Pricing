...
load("/Users/kojimadamsimith/Desktop/Summer Semester/Advanced Seminar/GBR/Original_Dataset/GBR_DS_static.RData")
```
...
Double_Sort_Set <- panel_reduced_MRP %>% 
  full_join(panel_reduced_beta_3, by = c("Id", "ym","RET.USD", "MV.USD")) %>% 
  full_join(panel_reduced_MV, by = c("Id", "ym", "RET.USD","MV.USD"))%>%
  full_join(panel_reduced_val, by = c("Id", "ym","year", "month","RET.USD","MV.USD"))%>% 
  full_join(panel_reduced_ROE, by = c("Id", "ym","RET.USD","MV.USD"))%>% 
  full_join(panel_reduced_inv, by = c("Id", "ym","RET.USD","MV.USD"))%>% 
  full_join(panel_reduced_momentum, by = c("Id", "ym","RET.USD","MV.USD"))%>% 
...
```{r}
save(Univariate_Sort_Set, file = "/Users/kojimadamsimith/Desktop/Summer Semester/Advanced Seminar/GBR/Univariate_Sort_Set.RData")
```
