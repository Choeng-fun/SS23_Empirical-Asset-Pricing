...
print(mean(check_r$RET))
print(((1+mean(check_r$RET)*0.01)^12-1))

print(sd(check_r$RET))
print(sd(check_r$RET)*sqrt(12)*0.01)

print(((1+mean(check_r$RET)*0.01)^12-1)/(sd(check_r$RET)*sqrt(12)*0.01))
```
...
```{r}
write.csv(quarterly_6_cum_performance, file = "/Users/kojimadamsimith/Desktop/Summer Semester/Advanced Seminar/GBR/SS23_Empirical-Asset-Pricing/performance.csv")
```
