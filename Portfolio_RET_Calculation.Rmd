...
```
```{r}
mean_6_performance <- quarterly_6_mean_performance %>% 
  filter(ym >= "1990-01-01")

mean_3_performance <- quarterly_3_mean_performance %>% 
  filter(ym >= "1990-01-01")

cum_6_performance <- quarterly_6_cum_performance %>% 
  filter(ym >= "1990-01-01")

cum_3_performance <- quarterly_3_cum_performance %>% 
  filter(ym >= "1990-01-01")
```
...
```{r}
save(mean_6_performance, file = "/Users/kojimadamsimith/Desktop/Summer Semester/Advanced Seminar/GBR/SS23_Empirical-Asset-Pricing/Performance/visual_annual&cumulative_result/mean_6_performance.RData")
save(mean_3_performance, file = "/Users/kojimadamsimith/Desktop/Summer Semester/Advanced Seminar/GBR/SS23_Empirical-Asset-Pricing/Performance/visual_annual&cumulative_result/mean_3_performance.RData")
save(cum_6_performance, file = "/Users/kojimadamsimith/Desktop/Summer Semester/Advanced Seminar/GBR/SS23_Empirical-Asset-Pricing/Performance/visual_annual&cumulative_result/cum_6_performance.RData")
save(cum_3_performance, file = "/Users/kojimadamsimith/Desktop/Summer Semester/Advanced Seminar/GBR/SS23_Empirical-Asset-Pricing/Performance/visual_annual&cumulative_result/cum_3_performance.RData")
```
