...
```{r}
panel_f <- Factor_data_ff5_FM[!is.na(Beta_3) & !is.infinite(Beta_3) & !is.na(`E/Pm`) & !is.infinite(`E/Pm`) & !is.na(NOA) & !is.infinite(NOA) & !is.na(AG) & !is.infinite(AG) & !is.na(NSI) & !is.infinite(NSI) & !is.na(MV) & !is.infinite(MV) & !is.na(Mom_12_2) & !is.infinite(Mom_12_2),
                                            .(gamma_zero=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[1],
                                              gamma_beta=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[2],
                                              gamma_epm=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[3],
                                              gamma_noa=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[4],
                                              gamma_ag=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[5],
                                              gamma_nsi=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[6],
                                              gamma_mv=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[7],
                                              gamma_mom=lm(Ex_RET.USD~Beta_3+`E/Pm`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[8])
                              ,by=ym]


panel_f[,t.test(gamma_zero)]
panel_f[,t.test(gamma_beta)]
panel_f[,t.test(gamma_epm)]
