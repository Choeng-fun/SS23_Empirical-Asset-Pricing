...
```{r}
panel_h2 <- Factor_data_ff5_FM_big[!is.na(Beta_3) & !is.infinite(Beta_3) & !is.na(`B/M`) & !is.infinite(`B/M`) & !is.na(NOA) & !is.infinite(NOA) & !is.na(NSI) & !is.infinite(NSI) & !is.na(MV) & !is.infinite(MV) & !is.na(Mom_12_2) & !is.infinite(Mom_12_2),
                                            .(gamma_zero=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[1],
                                              gamma_beta=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[2],
                                              gamma_bm=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[3],
                                              gamma_noa=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[4],
