...
```{r}
panel_f <- Factor_data_ff5_FM[!is.na(Beta_3) & !is.infinite(Beta_3) & !is.na(`B/M`) & !is.infinite(`B/M`) & !is.na(NOA) & !is.infinite(NOA) & !is.na(NSI) & !is.infinite(NSI) & !is.na(MV) & !is.infinite(MV) & !is.na(Mom_12_2) & !is.infinite(Mom_12_2),
                                            .(gamma_zero=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[1],
                                              gamma_beta=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[2],
                                              gamma_bm=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[3],
                                              gamma_noa=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[4],
                                              gamma_nsi=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[5],
                                              gamma_mv=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[6],
                                              gamma_mom=lm(RE.USD~Beta_3+`B/M`+NOA+NSI+MV+Mom_12_2)$coefficient[7])
                              ,by=ym]
...
panel_g <- Factor_data_ff5_FM[!is.na(Beta_3) & !is.infinite(Beta_3) & !is.na(`B/M`) & !is.infinite(`B/M`) & !is.na(`OP/BE`) & !is.infinite(`OP/BE`) & !is.na(NOA) & !is.infinite(NOA) & !is.na(AG) & !is.infinite(AG) & !is.na(NSI) & !is.infinite(NSI) & !is.na(MV) & !is.infinite(MV) & !is.na(Mom_12_2) & !is.infinite(Mom_12_2),
                                            .(gamma_zero=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[1],
                                              gamma_beta=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[2],
                                              gamma_bm=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[3],
                                              gamma_opbe=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[4],
                                              gamma_noa=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[5],
                                              gamma_ag=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[6],
                                              gamma_nsi=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[7],
                                              gamma_mv=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[8],
                                              gamma_mom=lm(RE.USD~Beta_3+`B/M`+`OP/BE`+NOA+AG+NSI+MV+Mom_12_2)$coefficient[9])
                              ,by=ym]
