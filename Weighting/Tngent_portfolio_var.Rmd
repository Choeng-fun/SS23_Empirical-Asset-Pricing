...
DS.monthly <- DS.monthly[is.na(RET.USD), RET.USD:=0]
>>>>>>> 84e5fe446509e2252161b8f14051594436a7a15c
```
...
#   top_20_stock_id_NoNA <- top_20_stock_id[!(top_20_stock_id %in% missing_stock_list)]
# }
...
seri_selected_past_data_df <- selected_past_data_df[,top_20_stock_id_NoNA]
...
# if(length(weights_df)==19){
#   weights_df <- c(weights_df,0)
#   names(weights_df)[20] <- "NA"
#   
#   #top_20_stock_id_NoNA <- C("top_20_stock_id_NoNA","NA")
# }

weights_df <- as.data.table(weights_df)

rm(cov_mat_month)
colnames(weights_df) = top_20_stock_id_NoNA
#weights_df[,ym:=dates[1]]
...
```{r}
#save result
weighted_result_quarterly_5_var_20 <-  weights_df_final
save(weighted_result_quarterly_5_var_20,file = "./Weighted_Result/weighted_result_quarterly_5_var_20.Rdata")

re_sd_result_quarterly_5_var_20 <-  er_sd_df_final
save(re_sd_result_quarterly_5_var_20,file = "./Weighted_Result/re_sd_result_quarterly_5_var_20.Rdata")
```
