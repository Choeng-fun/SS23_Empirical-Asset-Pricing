...
annual_returns_xts <- period.apply(quarterly_6_cum_performance, endpoints(quarterly_6_cum_performance, "years"), FUN = function(x) prod(1 + x) - 1)
...
write.csv(annual_6_cum_performance,file = "annual_6_cum_cumulative_return.csv")
