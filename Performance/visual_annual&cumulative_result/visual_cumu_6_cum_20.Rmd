...
weighted_result_quarterly_3_cum_20_complete <- weighted_result_quarterly_6_cum_20 %>%
...
write.csv(cumu_quarterly_3_cum_performance,file = "6_cum_cumulative_return.csv")
